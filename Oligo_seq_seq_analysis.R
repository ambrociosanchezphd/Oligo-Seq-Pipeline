...
colnames(n1) <- c("Pos -4", "Pos -3", "Pos -2", "Reoccurence", "Frequency")
colnames(n2) <- c("Pos -4", "Pos -3", "Pos -2", "Reoccurence", "Frequency")
...
write.xlsx2(table1, file = "Seq Analysis.xlsx", row.names = FALSE, sheetName = "Enrichment-Depletion")
# Sheet number 2 contains the reoccurence and frequency values of NNN combinations in sequences that contain TC and TT
write.xlsx2(n1, file = "Seq Analysis.xlsx", row.names = FALSE, sheetName = "All Sequences", append = TRUE)
# Sheet number 3 contains the reoccurence and frequency values of NNN combinations in sequences that contain TT only
write.xlsx2(n2, file = "Seq Analysis.xlsx", row.names = FALSE, sheetName = "Deaminated Sequences", append = TRUE)
